...
<div class="previewpage_sidebar" style="float:left">
   <a href="<?php echo $Database->address ?>Jobs-and-Services/edit_ad_page.php?ad_id=<?php echo $id ?>&adname=<?php echo $adname ?>" style="color: white"> <p style="padding: 10px 0;margin-top: 20px; background-color:#008080;text-align: center">Edit Ad</p></a>
