...
$buy = new buyandsellupdate();
	$buy->update_fashion($mobile,$file,$file2,$file3,$file4,$file5,$file6,$id,$adname,$desc, $price,$cloth,$watch,
...
<div style="margin-top: 40px; ">
		 ...
		 <td style="width: 80%; "> <select name="cloth" id="cloth_name" class="buyandsellad_inside_ad" value="<?php echo $result['clothing']?>"  >
...
<div style="margin-top: 40px; ">
		 <td style="width: 20%; "><strong>  Brand Name </strong></label></td>
		 <td style="width: 80%; "> <select name="watch" id="watch_name" class="buyandsellad_inside_ad" value="<?php echo $result['watches']?>" >
		 <option value="">Select</option>
			<?php
