...
$buy->update_electronics($mobile,$file,$file2,$file3,$file4,$file5,$file6,$id,$adname,$desc, $price,$laptop,$tv_name,
...
<div style="margin-top: 40px; ">
		 ...
		 <td style="width: 80%; "> <select name="laptop" id="laptop_name" class="buyandsellad_inside_ad" value="<?php echo $result['laptop']?>"  >
...
<div style="margin-top: 40px; ">
		 <td style="width: 20%; "><strong>  Maker </strong></label></td>
		 <td style="width: 80%; "> <select name="tv_name" id="tv_name" class="buyandsellad_inside_ad" value="<?php echo $result['tv_brand']?>" >
		 <option value="">Select</option>
			<?php
			$sql = "select * from tv ";                      
                        $res= $Database->add_query($sql);
...
<div style="margin-top: 40px; ">
		 ...
		 <td style="width: 80%; "><input type="text" name="location" class="buyandsellad_inside_ad" value="<?php echo $result['ad_address']?>"/><td>
</div>
</tr>
</table>
