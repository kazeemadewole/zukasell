...
<?php } ?>
	...
	$_SESSION['lgarea'] = $lgarea;
	 $url =  $Database->address."Electronics/tv_maker.php?id=".$_SESSION['answer']."&cat=".$cat."&lgarea=".$_SESSION['lgarea'];
	 $Database->redirect_to($url);
	}
	if(($cat != "") && ($lgarea == "")){
	$_SESSION['lgarea'] = "whole country";
	 $url =  $Database->address."Electronics/tv_maker.php?id=".$_SESSION['answer']."&cat=".$cat;
	 $Database->redirect_to($url);
	}
	if(($cat == "") && ($lgarea == "")){
	$_SESSION['lgarea'] = "whole country";
	$url =  $Database->address."Electronics/tv_maker.php?id=".$_SESSION['answer']."&lgarea=".$_SESSION['lgarea'];
	 $Database->redirect_to($url);
	}
	if(($cat == "") && ($lgarea != "")){
	$_SESSION['lgarea'] = $lgarea;
...
?>
    ...
    <span class="inside" style="color:white">Tv,Audio & Video</span>
