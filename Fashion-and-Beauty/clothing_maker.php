...
<div class="dropdown">
	...
	$_SESSION['lgarea'] = $lgarea;
	 $url =  $Database->address."Fashion-and-Beauty/clothing_maker.php?id=".$_SESSION['answer']."&cat=".$cat."&lgarea=".$_SESSION['lgarea'];
	 $Database->redirect_to($url);
	}
	if(($cat != "") && ($lgarea == "")){
	$_SESSION['lgarea'] = "whole country";
	 $url =  $Database->address."Fashion-and-Beauty/clothing_maker.php?id=".$_SESSION['answer']."&cat=".$cat;
	 $Database->redirect_to($url);
	}
	if(($cat == "") && ($lgarea == "")){
	$_SESSION['lgarea'] = "whole country";
	$url =  $Database->address."Fashion-and-Beauty/clothing_maker.php?id=".$_SESSION['answer']."&lgarea=".$_SESSION['lgarea'];
	 $Database->redirect_to($url);
	}
	if(($cat == "") && ($lgarea != "")){
	$_SESSION['lgarea'] = $lgarea;
   ...
   <div class="mainContent">
	...
	padding-bottom:10px">Latest Ads in Electronics</h2></header>
...
?>
    ...
    <a href="<?php echo $Database->address ?>Fashion-and-Beauty/" >
    <span >Fashion and Beauty</span></a>
    <span class="inside" style="color:white">Clothing and Shoes</span>
    <span class="inside"><?php echo $_SESSION['answer'] ?></span>
    </div>
    <div style="clear: both"></div>
    <?php
$maker = "clothing";
$cati = "Fashion and Beauty";
$buy = new buyandsell();
