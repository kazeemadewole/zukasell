...
$adname = preg_replace('#[^0-9a-z-_A-Z]#i', '', $_GET['adname']);
require_once($_SERVER['DOCUMENT_ROOT']."/database.php");
require_once($_SERVER['DOCUMENT_ROOT']."/user.php");
require_once($_SERVER['DOCUMENT_ROOT']."/buyandsellpost.php");
$page = "http://localhost:7080/project/";
$id = preg_replace('/[^0-9]/', '', $_GET['ad_id']);
...
<script>
  (adsbygoogle = window.adsbygoogle || []).push({
	...
	<meta charset="utf-8" />
	<title>Zukasell-<?php echo $adname ?></title>
