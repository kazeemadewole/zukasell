...
<div class="dropdown">
	...
	$_SESSION['lgarea'] = $lgarea;
	 $url =  $Database->address."Mobile-Phones-and-Tablets/phone_maker.php?id=".$_SESSION['answer']."&cat=".$cat."&lgarea=".$_SESSION['lgarea'];
	 $Database->redirect_to($url);
	}
	if(($cat != "") && ($lgarea == "")){
	$_SESSION['lgarea'] = "whole country";
	 $url =  $Database->address."Mobile-Phones-and-Tablets/phone_maker.php?id=".$_SESSION['answer']."&cat=".$cat;
	 $Database->redirect_to($url);
	}
	if(($cat == "") && ($lgarea == "")){
	$_SESSION['lgarea'] = "whole country";
	$url =  $Database->address."Mobile-Phones-and-Tablets/phone_maker.php?id=".$_SESSION['answer']."&lgarea=".$_SESSION['lgarea'];
	 $Database->redirect_to($url);
	}
	if(($cat == "") && ($lgarea != "")){
	$_SESSION['lgarea'] = $lgarea;
   ...
   <div class="mainContent">
	...
	padding-bottom:10px">Latest Ads in Phones&Tablets</h2></header>
...
<div class="sub_header">
    ...
    <span >Phones & Tablets</span></a>
    <span class="inside" style="color:white">Phones</span>
