...
$buy = new buyandsellupdate();
	...
	$buy->update_RealEstate($mobile,$file,$file2,$file3,$file4,$file5,$file6,$id,$adname,$desc, $price,$ad_loc,
...
<div style="margin-top: 40px; ">
		 ...
		 <td style="width: 80%; "><input id="ad_loc" name="ad_loc" type="text" class="buyandsellad_inside_ad" value="<?php echo $result['ad_address']?>"/></td>
</div>
</tr>
</table>
<?php } ?>
