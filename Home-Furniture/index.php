...
$session->start_login();
	...
	$_SESSION['lgarea'] = $lgarea;
	 $url =  $Database->address."Home-Furniture/?cat=".$cat."&lgarea=".$_SESSION['lgarea'];
	 $Database->redirect_to($url);
	}
	if(($cat != "") && ($lgarea == "")){
	$_SESSION['lgarea'] = "whole country";
	 $url =  $Database->address."Home-Furniture/?cat=".$cat;
	 $Database->redirect_to($url);
	}
	if(($cat == "") && ($lgarea == "")){
	$_SESSION['lgarea'] = "whole country";
	$url =  $Database->address."Home-Furniture/?lgarea=".$_SESSION['lgarea'];
	 $Database->redirect_to($url);
	}
	if(($cat == "") && ($lgarea != "")){
	$_SESSION['lgarea'] = $lgarea;
...
<script>
  (adsbygoogle = window.adsbygoogle || []).push({
	...
	<meta charset="utf-8" />
     <title>Zukasell- Home,Furniture and Garden  </title> 
        <meta name="description" content="Latest Ad in Home Furniture and Garden: Home Appliances, Garden Accessories, Furniture ...." />
<meta name="keywords" content="Zukasell, home,furniture,garden,accessories">
...
(adsbygoogle = window.adsbygoogle || []).push({});
 ...
 <div class="mainContent">
	<article>
	<header class="topHeader" ><h2 style="font-size:medium; margin-left: 5%;
	padding-bottom:10px">Latest Ads on Home,Furniture</h2></header>
	<div class="inside_vehicle" style="background-color: white">
		<div class="list">
<a href="javascript://" onclick="makerequest('<?php echo $Database->address ?>dynamic.php?id=Furniture &cati=Home, Furniture and Garden &maker=subcategory&loc=<?php echo $_SERVER['REQUEST_URI'] ?>&cat=Furniture', 'display_box')">
		<li  class="items">Furniture</li>
</a>
<a href="javascript://" onclick="makerequest('<?php echo $Database->address ?>dynamic.php?id=Home Appliances &cati=Home, Furniture and Garden &maker=subcategory&loc=<?php echo $_SERVER['REQUEST_URI'] ?>&cat=Home Appliances', 'display_box')">
		<li class="items">Home Appliances</li>
</a>
<a href="javascript://" onclick="makerequest('<?php echo $Database->address ?>dynamic.php?id=Garden Accessories &cati=Home, Furniture and Garden &maker=subcategory&loc=<?php echo $_SERVER['REQUEST_URI'] ?>&cat=Garden Accessories', 'display_box')">
		<li class="items">Garden Access....</li>
</a>
<a href="javascript://" onclick="makerequest('<?php echo $Database->address ?>dynamic.php?id=Others &cati=Home, Furniture and Garden &maker=subcategory&loc=<?php echo $_SERVER['REQUEST_URI'] ?>&cat=Others', 'display_box')">
...
<?php
$buy = new buyandsell();
$table = "Home, Furniture and Garden";
$tabs= "Home-Furniture";
