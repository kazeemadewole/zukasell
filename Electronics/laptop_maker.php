...
<?php } ?>
	...
	$_SESSION['lgarea'] = $lgarea;
	 $url =  $Database->address."Electronics/laptop_maker.php?id=".$_SESSION['answer']."&cat=".$cat."&lgarea=".$_SESSION['lgarea'];
	 $Database->redirect_to($url);
	}
	if(($cat != "") && ($lgarea == "")){
	$_SESSION['lgarea'] = "whole country";
	 $url =  $Database->address."Electronics/laptop_maker.php?id=".$_SESSION['answer']."&cat=".$cat;
	 $Database->redirect_to($url);
	}
	if(($cat == "") && ($lgarea == "")){
	$_SESSION['lgarea'] = "whole country";
	$url =  $Database->address."Electronics/laptop_maker.php?id=".$_SESSION['answer']."&lgarea=".$_SESSION['lgarea'];
	 $Database->redirect_to($url);
	}
	if(($cat == "") && ($lgarea != "")){
	$_SESSION['lgarea'] = $lgarea;
...
?>
    ...
    <a href="<?php echo $Database->address ?>Electronics/" >
    <span>Electronics</span></a>
    <span class="inside" style="color:white">Computer & Laptops</span>
